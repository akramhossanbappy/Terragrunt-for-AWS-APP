# Region root for preprod ap-southeast-1 units.
#
# Terminal config (no include blocks) — Terragrunt auto-loads parent
# terragrunt.hcl files, so live/terragrunt.hcl and preprod/terragrunt.hcl
...
# generated here; the env root (preprod/terragrunt.hcl) provides the S3
