# preprod / us-east-1 region

Region root for the preprod environment in AWS `us-east-1`. **No
...
- [`../README.md`](../README.md) — preprod env overview.
- [`../ap-southeast-1/README.md`](../ap-southeast-1/README.md) — main preprod region.
