# Root Terragrunt config for the preprod environment.
#
...
# and the region roots are picked up automatically by units under preprod/.
#
# Defines preprod-specific locals: the S3 state bucket name,
...
locals {
  ...
  state_bucket           = "REPLACE_WITH_PREPROD_STATE_BUCKET"
