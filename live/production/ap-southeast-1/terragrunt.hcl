# Region root for production ap-southeast-1 units.
#
# Terminal config (no include blocks) — Terragrunt auto-loads parent
# terragrunt.hcl files, so live/terragrunt.hcl and production/terragrunt.hcl
...
# generated here; the env root (production/terragrunt.hcl) provides the S3
