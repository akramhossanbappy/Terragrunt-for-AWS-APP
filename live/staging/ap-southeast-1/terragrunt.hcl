# Region root for staging ap-southeast-1 units.
#
# Terminal config (no include blocks) — Terragrunt auto-loads parent
# terragrunt.hcl files, so live/terragrunt.hcl and staging/terragrunt.hcl
...
# generated here; the env root (staging/terragrunt.hcl) provides the S3
